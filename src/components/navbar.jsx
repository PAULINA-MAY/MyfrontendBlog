    ...
    <nav className="bg-white shadow">
          ...
          <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:block sm:ml-6">
              <div className="flex space-x-4">
                ...
                <a href="/contact" className="text-gray-800 hover:bg-gray-100 hover:text-gray-500 px-3 py-2 rounded-md text-sm font-medium">Contacto</a>
              </div>
            </div>
          </div>
      ...
      <div className="sm:hidden" id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <a href="/contact" className="text-gray-800 hover:bg-gray-100 hover:text-gray-500 block px-3 py-2 rounded-md text-base font-medium">Contacto</a>
        </div>
      </div>
    </nav>
  );
